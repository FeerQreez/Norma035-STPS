				...
				<table id="user_data" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th width="35%">IdCatePu</th>
							<th width="35%">NomCata</th>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					<label>Ingresa tu Id de Categoria Puesto</label>
					<input type="text" name="nombre" id="NombreTra" class="form-control" />
					<br />
					<label>Ingresa tu Nombre de Categoria</label>
					<input type="text" name="Apellido_P" id="Apellido_P" class="form-control" />
					<br />
					<label>Ingresa el ID de tu  Puesto</label>
...
$(document).ready(function(){
	...
	$(document).on('submit', '#user_form', function(event){
		...
		var idCatePu = $('#IdCatePu').val();
		var NomCata = $('#NomCata').val();
